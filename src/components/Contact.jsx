...
export default function Contact() {
  ...
  return (
    <section id="kontakt" className="py-24 lg:py-32 bg-bark relative overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-bark-light/30 to-transparent" />

      {/* Background Shapes */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-terra/[0.06] rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-72 h-72 bg-sage/[0.04] rounded-full blur-3xl pointer-events-none" />
      ...
      >
        <div className="grid lg:grid-cols-[1fr,1.1fr] gap-16 lg:gap-24">
          ...
          <div>
            ...
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-[2.75rem] font-medium text-white leading-tight mb-6">
              Lassen Sie uns{' '}
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-terra/10 flex items-center justify-center shrink-0 mt-0.5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-white/40 text-sm mb-1">Standort</p>
                  <p className="text-white text-lg">Österreich</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-white/40 text-sm mb-1">Erstgespräch</p>
          ...
          <div>
            {submitted ? (
              <div className="bg-white/5 border border-white/10 rounded-2xl p-10 text-center">
                ...
                <h3 className="font-serif text-2xl text-white mb-3">Vielen Dank!</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label htmlFor="thema" className="block text-sm text-white/50 mb-2">
                    Thema
                  </label>
                  <select
                    id="thema"
                  ...
                  >
                    ...
                    <option value="lebensberatung" className="bg-bark">Lebens- & Sozialberatung</option>
                ...
                <div>
                  <label htmlFor="nachricht" className="block text-sm text-white/50 mb-2">
                    Nachricht
                  </label>
                  <textarea
                    id="nachricht"
